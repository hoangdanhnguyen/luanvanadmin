...
import 'package:admin_luanvan/views/products_screen/add_product.dart';
import 'package:admin_luanvan/views/products_screen/edit_product.dart';
                  ...
                  child: ListTile(
                    onTap: () {
                      Get.to(() => ProductDetails(data: data[index]));
                        ...
                        subtitle: Row(
                          children: [
                            normalText(text: "${data[index]['p_price']} VND", color: darkGrey),
                            //"${data[index]['p_price']}".numVND.text.make(),
                            10.widthBox,
                        ...
                        trailing: VxPopupMenu(
                          arrowSize: 0.0,
                          menuBuilder: ()=>Column(
                            children: List.generate(popupMenuTitle.length, (i) => Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  10.widthBox,
                                  normalText(text: data[index]['featured_id'] == currentUser!.uid && i == 0 ? 'Remove feature' : popupMenuTitle[i], color: darkGrey)
                                ],
                              ).onTap(() {
                                switch (i) {
                                  case 0:
