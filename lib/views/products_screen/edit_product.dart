    ...
    return Obx(
      () =>Scaffold(
        ...
        appBar: AppBar(
          ...
          title: boldText(text: "Edit Product", color: lightGrey, size: 16.0),
          actions: [
            controller.isLoading.value ? loadingIndicator(cicleColor: white) : TextButton(
              onPressed: () async {
                controller.isLoading(true);
                await controller.uploadImage();
                await controller.uploadEditProduct(context);
                Get.back();
              },
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 10.heightBox,
                // customTextField(hint: "quantity", label: "Quantity", controller: controller.pquantityControllerM),
                // 10.heightBox,
                // customTextField(hint: "quantity", label: "Quantity", controller: controller.pquantityControllerL),
                // 10.heightBox,
                // customTextField(hint: "quantity", label: "Quantity", controller: controller.pquantityControllerXL),
                // 10.heightBox,
                // customTextField(hint: "quantity", label: "Quantity", controller: controller.pquantityControllerXXL),
                //10.heightBox,
