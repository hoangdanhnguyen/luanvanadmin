...
import 'package:admin_luanvan/views/orders_screen/components/order_place.dart';
import 'package:admin_luanvan/views/widget/button.dart';
            ...
            child: Column(
              children: [
                ...
                Visibility(
                  ...
                  ).box.padding(const EdgeInsets.all(8.0)).outerShadow.white.border(color: lightGrey).roundedSM.make(),
                ),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  normalText(text: "Name:", color: Colors.black),
                                  5.widthBox,
                              ...
                              Row(
                                children: [
                                  normalText(text: "Address:", color: Colors.black),
                                  5.widthBox,
                              ...
                              Row(
                                children: [
                                  normalText(text: "City:", color: Colors.black),
                                  5.widthBox,
                              ...
                              Row(
                                children: [
                                  normalText(text: "State:", color: Colors.black),
                                  5.widthBox,
                              ...
                              Row(
                                children: [
                                  normalText(text: "Phone:", color: Colors.black),
                                  5.widthBox,
                              ...
                              Row(
                                children: [
                                  normalText(text: "Postal code:", color: Colors.black),
                                  5.widthBox,
                ...
                ).box.outerShadow.white.border(color: lightGrey).roundedSM.make(),
                const Divider(),
                10.heightBox,
